...
LOCAL_INLINE FUNC(void, ETH_CODE) Eth_Enet_CorrectRate ( \
                                                    ...
                                                    CONST(uint32, AUTOMATIC) u32CorrectValue \
                                                          );
...
* @param[in]    u32CorrectValue Value to be loaded at correct cycle
*/
LOCAL_INLINE FUNC(void, ETH_CODE) Eth_Enet_CorrectRate ( \
                                                    CONST(uint8, AUTOMATIC) u8CtrlIdx, \
                                                    CONST(uint32, AUTOMATIC) u32CorrectCycle, \
                                                          ...
                                                          )
{
    ...
    /** @violates @ref Eth_Enet_c_REF_2 MISRA rule 11.3 */       
    /** @violates @ref Eth_Enet_c_REF_7 MISRA rule 11.1 */
    REG_RMW32(Eth_u32BaseAddr[u8CtrlIdx] + ENET_ATINC_ADDR16, (VAR(uint32, AUTOMATIC))ENET_ATINC_INC_CORR_U32, ((VAR(uint32, AUTOMATIC))u32CorrectValue << (VAR(uint32, AUTOMATIC))8U) );
}
                                                 ...
                                                 )
{
    ...
    if (s64IngNanosecond != s64OriNanosecond)
    {
        ...
        if (0 == s32CorrectCycle) 
        {
            ...
            Eth_Enet_CorrectRate(u8CtrlIdx, 1U, (VAR(uint32, AUTOMATIC))s32CorrectValue);
        }
        else if (0 < s32CorrectCycle) 
        {
            ...
            /** @violates @ref Eth_Enet_c_REF_5 MISRA rule 17.4 */
            /** @violates @ref Eth_Enet_c_REF_20 MISRA rule 10.1 */
            Eth_Enet_CorrectRate(u8CtrlIdx, (VAR(uint32, AUTOMATIC))s32CorrectCycle, (VAR(uint32, AUTOMATIC))(ETH_CFG_TIMESTAMP_INC(u8CtrlIdx) + 1U));
        }
        else
        {
