...
#if (LIN_VENDOR_ID_CFG_C != REG_ESYS_FLEXIO_VENDOR_ID)
    #error "Lin_Cfg.c and Reg_eSys_FlexIO.h have different vendor ids"
#endif
/* Check if current file and Reg_eSys_FlexIO.h header file are of the same Autosar version */
     ...
     (LIN_AR_RELEASE_REVISION_VERSION_CFG_C != REG_ESYS_FLEXIO_AR_RELEASE_REVISION_VERSION) \
    )
