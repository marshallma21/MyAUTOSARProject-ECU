...
*/
/** @violates @ref CDD_I2c[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!IF "$Type = 'PC'"!]_Cfg[!ELSE!]_PBcfg[!ENDIF!][!ENDIF!]_c_REF_3 MISRA 2004 Required Rule 8.10, external linkage */
...
*/
/** @violates @ref CDD_I2c[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!IF "$Type = 'PC'"!]_Cfg[!ELSE!]_PBcfg[!ENDIF!][!ENDIF!]_c_REF_4 MISRA 2004 Required Rule 1.4, 31 character significance */
...
[!VAR "TxShifterId" = "num:i(substring-before(substring-after(node:value(I2cHwChannel),'FLEXIO_0_CH_'),'_'))"!][!//
[!VAR "RxShifterId" = "num:i(substring-after(substring-after(node:value(I2cHwChannel),'FLEXIO_0_CH_'),'_'))"!][!//
[!VAR "SclPinId" = "num:i(substring-after(I2cFlexIOConfiguration/I2cFlexIOSclPin,'FXIO_D'))"!][!//
[!VAR "SdaPinId" = "num:i(substring-after(I2cFlexIOConfiguration/I2cFlexIOSdaPin,'FXIO_D'))"!][!//
    /* SCL Timer config */
    {
        /* Timer ID */
        (uint32)[!"num:i($SclTimerId)"!]U,
        /* Timer Control Config */
        (
            (uint32)(((uint32)((uint32)[!"num:i($TxShifterId)"!]U << 2U) + 1U) << FLEXIO_TIMCTL_TRGSEL_SHIFT_U32) |
            FLEXIO_TMR_TRIGGER_ACTIVE_LOW_U32 |
            FLEXIO_TMR_INTERNAL_TRIGGER_U32 |
            FLEXIO_TMR_PIN_OPEN_DRAIN_U32 |
            (uint32)(((uint32)[!"num:i($SclPinId)"!]U) << FLEXIO_TIMCTL_PINSEL_SHIFT_U32) |
    ...
    {
        /* TX Shifter ID */
        (uint32)[!"num:i($TxShifterId)"!]U,
        (
            (uint32)(((uint32)[!"num:i($CtlTimerId)"!]U)  << FLEXIO_SHIFTCTL_TIMSEL_SHIFT_U32) |
            FLEXIO_SHIFT_ON_POSEDGE_OF_SHIFT_CLK_U32 |
            FLEXIO_SHIFTER_PIN_OPEN_DRAIN_U32 |
            (uint32)(((uint32)[!"num:i($SdaPinId)"!]U) << FLEXIO_SHIFTCTL_PINSEL_SHIFT_U32) |
...
[!CODE!]
    /* Start of I2c_ChannelConfig[[!"@index"!]]*/
    {
        ...
        {
            [!IF "contains(node:value(I2cHwChannel), 'LPI2C')"!]I2C_LPI2C_CHANNEL[!ELSE!]I2C_FLEXIO_CHANNEL[!ENDIF!],

            [!IF "(../../../GeneralConfiguration/I2cFlexIOUsed='false')"!]
