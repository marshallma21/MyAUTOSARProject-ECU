...
[!ENDMACRO!]
[!/* *************************** Flexio SECTION Config ******************************
******************************************************************************************/!]
[!MACRO "FlexioConfig","FlexioConfigType"!]
[!VAR "NumofChannelConfig" = "num:i(count(./FlexioConfig/FlexioReferenceConfiguration/*))"!][!//
[!IF "$FlexioConfigType = 'PC'"!][!//
static CONST( Mcl_FlexioConfigType, MCL_CONST) Mcl_Flexio_Config_PC =
[!ELSEIF "$FlexioConfigType = 'PB'"!][!//
static CONST( Mcl_FlexioConfigType, MCL_CONST) Mcl_Flexio_Config_[!"@index"!] =
[!ELSE!][!//
static CONST( Mcl_FlexioConfigType, MCL_CONST) Mcl_Flexio_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!] =
[!ENDIF!][!//
{
    ([!IF "./FlexioConfig/FlexioGeneral/DozenEnable = 'true'"!]FLEXIO_CTRL_DOZEN_EN_U32) |[!ELSE!]FLEXIO_CTRL_DOZEN_DIS_U32) |[!ENDIF!] \
    ([!IF "./FlexioConfig/FlexioGeneral/DBGE = 'true'"!]FLEXIO_CTRL_DBGE_EN_U32) [!ELSE!]FLEXIO_CTRL_DBGE_DIS_U32)[!ENDIF!],
    [!"$NumofChannelConfig"!]U
};
[!ENDMACRO!]
