...
#define MCL_PBCFG[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_SW_PATCH_VERSION_C              2
...
[!IF "../../MclGeneral/EnableFlexioSupport"!][!//   
/**
...
*/
/** @violates @ref Mcl_PBcfg[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]_REF_10 external ... could be made static */
[!CALL "FlexioConfig","FlexioConfigType" = "'PBvariant'"!]
[!ENDIF!][!//EnableFlexioSupport
...
[!ENDIF!][!//EnableDMA
    ...
    [!IF "../../MclGeneral/EnableFlexioSupport"!][!// 
       [!IF "$comma = 1"!]
        ...
        &Mcl_Flexio_Config[!IF "var:defined('postBuildVariant')"!]_[!"$postBuildVariant"!][!ENDIF!]
        [!VAR "comma" = "1"!] 
    [!ENDIF!][!//EnableFlexioSupport
    };
[!ENDLOOP!]
