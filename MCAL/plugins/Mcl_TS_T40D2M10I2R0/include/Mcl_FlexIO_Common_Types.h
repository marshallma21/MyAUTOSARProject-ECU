...
#define FLEXIO_COMMON_TYPES_AR_RELEASE_MINOR_VERSION        2
#define FLEXIO_COMMON_TYPES_AR_RELEASE_REVISION_VERSION     2
#define FLEXIO_COMMON_TYPES_SW_MAJOR_VERSION                1
#define FLEXIO_COMMON_TYPES_SW_MINOR_VERSION                0
#define FLEXIO_COMMON_TYPES_SW_PATCH_VERSION                2
/** @} */
