...
*     @details    This file is the CRC driver configuration header. This file is automatically generated, do not modify manually.
*     
...
#define CRCU_CFG_SW_PATCH_VERSION            2
