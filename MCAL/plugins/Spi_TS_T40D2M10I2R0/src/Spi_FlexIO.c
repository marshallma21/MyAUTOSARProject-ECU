...
*/
#define SPI_FLEXIO_AR_RELEASE_MINOR_VERSION_C         2
/*
...
*/
#define SPI_FLEXIO_AR_RELEASE_REVISION_VERSION_C      2
...
#define SPI_FLEXIO_DMA_MAX_LINKED_ITER_CNT  (0x7FFu)
    ...
    )
{
    ...
    */
    ...
    if ((Std_ReturnType)E_OK != Spi_FlexIO_Status)
    {
        ...
        {
            (void)Dem_ReportErrorStatus((Dem_EventIdType)Spi_pcSpiConfigPtr->Spi_E_Hardware_ErrorCfg.id, DEM_EVENT_STATUS_FAILED);
        }
        else
        {
            /* Do nothing */
    ...
    else
    {
        ...
        if ((uint32)STD_ON == Spi_pcSpiConfigPtr->Spi_E_Hardware_ErrorCfg.state)
        {
            (void)Dem_ReportErrorStatus((Dem_EventIdType)Spi_pcSpiConfigPtr->Spi_E_Hardware_ErrorCfg.id, DEM_EVENT_STATUS_PASSED);
        }
        else
        {
            /* Do nothing */
