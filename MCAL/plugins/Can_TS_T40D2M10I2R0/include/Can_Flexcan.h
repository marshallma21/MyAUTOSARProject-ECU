        ...
        */
        #define CAN_RXFIFO_EVENTS_MB_MIX(FC,IdMax) \
            ISR(Can_IsrFC##FC##_RxFifoEventsMbMix) { \
                    ...
                    { \
                        if (((uint32)0U == (CAN_CONTROLLERCONFIG_TXPOL_EN_U32 & (CanStatic_pControlerDescriptors[CAN_FC##FC##_INDEX].u32Options)))) \
                        { \
...
{ \
    ...
    { \
        if (CAN_CONTROLLERCONFIG_TXPOL_EN_U32 != (CAN_CONTROLLERCONFIG_TXPOL_EN_U32 & CanStatic_pControlerDescriptors[CAN_FC##FC##_INDEX].u32Options)) \
        { \
        ...
        if (CAN_CONTROLLERCONFIG_RXPOL_EN_U32 != (CAN_CONTROLLERCONFIG_RXPOL_EN_U32 & CanStatic_pControlerDescriptors[CAN_FC##FC##_INDEX].u32Options)) \
        { \
