...
Std_ReturnType Rte_Call_SwtSensor_SwtSensorInstance_SwtSignal_Read(/*OUT*/DigitalLevel * Level, /*OUT*/SignalQuality * Quality) {
    return Rte_Call_IoHwAb_IoHwAbInstance_Digital_Swt_Read(Level, Quality);
}

/** ------ SwtSts */
/*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required]*/
Std_ReturnType Rte_Write_SwtSensor_SwtSensorInstance_SwtSts_status(/*IN*/SwitchStatusImpl value) {
    Std_ReturnType retVal = RTE_E_OK;

    /* --- Sender (SwtSensorInstance_SwtSts_to_LightManagerInstance_BtnPressed) */
    {
        SYS_CALL_AtomicCopyBoolean(Rte_Buffer_LightManagerInstance_BtnPressed_status, value);
    }
