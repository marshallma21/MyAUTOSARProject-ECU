...
/** === Runnables =================================================================================
 */
extern void Rte_BlueLiActuatorInstance_LEDActuatorMain(void);
extern void Rte_LightManagerInstance_RedLiDimming(void);
extern void Rte_LightManagerInstance_TimeToggleLED(void);
extern void Rte_PotSensorInstance_PotSensorMain(void);
extern void Rte_RedLiIntControllerInstance_IntControllerMain(void);
extern void Rte_SwtSensorInstance_SwtSensorMain(void);
...
void OsRteTask(void) { /** @req SWS_Rte_02251 */
    ...
    do {
        ...
        SYS_CALL_GetEvent(TASK_ID_OsRteTask, &Event); /*lint !e534 !e923*/

        if ((Event & EVENT_MASK_OsRteEvent) != 0) {
            SYS_CALL_ClearEvent(EVENT_MASK_OsRteEvent);/*lint !e534 RTE Requirement */
            Rte_BlueLiActuatorInstance_LEDActuatorMain();
        }
        if ((Event & EVENT_MASK_OsRteEvent) != 0) {
            SYS_CALL_ClearEvent(EVENT_MASK_OsRteEvent);/*lint !e534 RTE Requirement */
            Rte_PotSensorInstance_PotSensorMain();
        }
        if ((Event & EVENT_MASK_OsRteEvent) != 0) {
            SYS_CALL_ClearEvent(EVENT_MASK_OsRteEvent);/*lint !e534 RTE Requirement */
            Rte_LightManagerInstance_RedLiDimming();
        }
        if ((Event & EVENT_MASK_OsRteEvent) != 0) {
            SYS_CALL_ClearEvent(EVENT_MASK_OsRteEvent);/*lint !e534 RTE Requirement */
            Rte_LightManagerInstance_TimeToggleLED();
        }
        if ((Event & EVENT_MASK_OsRteEvent) != 0) {
            SYS_CALL_ClearEvent(EVENT_MASK_OsRteEvent);/*lint !e534 RTE Requirement */
            Rte_RedLiIntControllerInstance_IntControllerMain();
        }
        if ((Event & EVENT_MASK_OsRteEvent) != 0) {
            SYS_CALL_ClearEvent(EVENT_MASK_OsRteEvent);/*lint !e534 RTE Requirement */
            Rte_SwtSensorInstance_SwtSensorMain();
        }
