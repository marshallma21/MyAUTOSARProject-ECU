...
Std_ReturnType Rte_Call_IntController_RedLiIntControllerInstance_DutySignal_Set(/*IN*/DutyCycle DutyValue, /*OUT*/SignalQuality * Quality) {
    return Rte_Call_IoHwAb_IoHwAbInstance_Pwm_RedLEDDuty_Set(DutyValue, Quality);
}

/** ------ IntSts */
/*lint -e621 MISRA:OTHER:Ignore misidentified symbol clash [MISRA 2012 Rule 5.5, required]*/
Std_ReturnType Rte_Read_IntController_RedLiIntControllerInstance_IntSts_status(/*OUT*/IntensityStatusImpl * value) {
    Std_ReturnType retVal = RTE_E_OK;

    /* --- Receiver (LightManagerInstance_RedLiIntSts_to_RedLiIntControllerInstance_IntSts) */
    {
        SYS_CALL_AtomicCopy32(*value, Rte_Buffer_RedLiIntControllerInstance_IntSts_status);
    }
