...
SECTION_POSTBUILD_DATA const PduRDestPdu_type PduRDestination_ECU01_01_3FE_PduRDestPdu = {
		.DestModule 	= ARC_PDUR_COM,
		.DestPduId		= ComConf_ComIPdu_ECU01_01_3FE,
		.NofGroupRefs = 0,
...
SECTION_POSTBUILD_DATA const PduRDestPdu_type PduRDestination_MyECU_01_3FF_PduRDestPdu = {
		.DestModule 	= ARC_PDUR_CANIF,
		.DestPduId		= CANIF_PDU_ID_MYECU_01_3FF,
		.NofGroupRefs = 0,
		.RoutingPathGroupRefs = NULL,
		.DataProvision	= PDUR_NO_PROVISION,
		.TxBufferId		= PDUR_NO_BUFFER	
...
SECTION_POSTBUILD_DATA const PduRDestPdu_type * const PduRDestinations_ECU01_01_3FE[] = {
	&PduRDestination_ECU01_01_3FE_PduRDestPdu,
	NULL
};

SECTION_POSTBUILD_DATA const PduRDestPdu_type * const PduRDestinations_MyECU_01_3FF[] = {
	&PduRDestination_MyECU_01_3FF_PduRDestPdu,
	NULL
};

// Routing paths

SECTION_POSTBUILD_DATA const PduRRoutingPath_type PduRRoutingPath_ECU01_01_3FE = { 
	.SrcModule = ARC_PDUR_CANIF,
	.SrcPduId = CANIF_PDU_ID_ECU01_01_3FE,
	.PduRDestPdus = PduRDestinations_ECU01_01_3FE,
...
SECTION_POSTBUILD_DATA const PduRRoutingPath_type PduRRoutingPath_MyECU_01_3FF = { 
	.SrcModule = ARC_PDUR_COM,
	.SrcPduId = ComConf_ComIPdu_MyECU_01_3FF,
	.PduRDestPdus = PduRDestinations_MyECU_01_3FF,
...
SECTION_POSTBUILD_DATA const PduRRoutingPath_type * const PduRRoutingPaths[] = { 
	&PduRRoutingPath_ECU01_01_3FE,
	&PduRRoutingPath_MyECU_01_3FF,
	NULL
};
