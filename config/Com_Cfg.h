...
#define COM_MAX_BUFFER_SIZE	 					24

#define COM_MAX_N_IPDUS								2
#define COM_MAX_N_SIGNALS							3
...
#define ComConf_ComSignal_IntReq          0
#define ComConf_ComSignal_LEDSts          1
#define ComConf_ComSignal_PotValue          2
