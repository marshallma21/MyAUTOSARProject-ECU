...
SECTION_POSTBUILD_DATA const CanIf_RxPduConfigType HrhRxPdu_CanIfHrhCfg[] = {
	{
		.CanIfCanRxPduId 			= PDUR_PDU_ID_ECU01_01_3FE,
    	.CanIfCanRxPduLowerCanId 	= 1022,
    	.CanIfCanRxPduUpperCanId 	= 1022,
    	.CanIfCanRxPduDlc 			= 8,
...
SECTION_POSTBUILD_DATA const CanIf_HthConfigType CanIfHthConfigData_CanIfInitHohCfg[] =
{
	{ 
    	...
    	.CanIfHthIdSymRef 			= CanConf_CanHardwareObject_CanHardwareObject_1,
	},
};

SECTION_POSTBUILD_DATA const uint16 CanIfCanHohToCanIfHrhMap_CanIfInitHohCfg[] = {
    [CanConf_CanHardwareObject_CanHardwareObject_0] = CanIfInitHohCfg_CanIfHrhCfg_INDEX,
    [CanConf_CanHardwareObject_CanHardwareObject_1] = NO_CANIF_HRH,
};
...
SECTION_POSTBUILD_DATA const CanIf_TxPduConfigType CanIfTxPduConfigData[] = {
    {
        .CanIfTxPduId               = PDUR_REVERSE_PDU_ID_MYECU_01_3FF,
        .CanIfCanTxPduIdCanId       = 1023,
...
SECTION_POSTBUILD_DATA const CanIf_Arc_ChannelConfigType CanIf_Arc_ChannelConfig[CANIF_CHANNEL_CNT] = { 
	{
		/* CanIfCtrlCfg */
		.CanControllerId 		= (uint32)CanConf_CanController_CanController_0,
		.NofTxBuffers 			= 1,
