...
const EcuM_SleepModeType EcuM_SleepModeConfig[] = {
	{  // EcuMSleepMode
	   ...
	   .EcuMWakeupSourceMask = EcuMConf_EcuMWakeupSource_EcuMWakeupSource,
  	   .EcuMSleepModeMcuMode = McuConf_McuModeSettingConf_McuModeSettingConf_Sleep,   /* @req SWS_EcuM_02958 */
    }
...
const EcuM_ConfigType EcuMConfig = {
    ...
    .EcuMNormalMcuMode = McuConf_McuModeSettingConf_McuModeSettingConf_Run,
